...
<form action="${pageContext.request.contextPath}/admin/videoUpload" method="get">
	...
	<label for="title">Title : </label><input type="text" id="title" name="title" value="${videoInfo.title }" ${empty videoInfo ? '' : 'disabled' }>
	...
	<label for="season">season : </label><input type="text" id="season" name="season" value="${empty videoInfo.season ? 00 : videoInfo.season }" ${empty videoInfo ? '' : 'disabled' }>
	<br>
	<label for="episode">episode : </label><input type="text" id="episode" name="episode" value="${empty videoInfo.episode ? 00 : videoInfo.episode }" ${empty videoInfo ? '' : 'disabled' }>
	<br>
	
	<label for="link">File : </label>
	<input type="text" id="link" name="link" readonly="readonly" value="${videoInfo.link }" ${empty videoInfo ? '' : 'disabled' }>
	<input type="button" id="linkFile" value="Files" onClick="FilePath('link');return false;" ${empty videoInfo ? '' : 'disabled' }> 
	<br>
	...
	<c:if test="${empty videoInfo }">
		...
		<input type="text" id="poster" name="poster" readonly="readonly">
		<input type="button" id="posterFile" value="Files" onClick="FilePath('poster');return false;">
		<br>
		<label for="teaser">Teaser : </label>
		<input type="text" id="teaserLink" name="teaserLink" readonly="readonly">
	...
	<input type="button" id="subEngFile" onchange="FilePath('subEng')" value="Files" onClick="FilePath('subEng');return false;" ${empty videoInfo ? '' : 'disabled' }>
	<br>
	...
	<input type="button" id="subKorFile" onchange="FilePath('subKor')" value="Files" onClick="FilePath('subKor');return false;" ${empty videoInfo ? '' : 'disabled' }>
	<br>
	...
	<input type="button" id="subMixFile" onchange="FilePath('subMix')" value="Files" onClick="FilePath('subMix');return false;" ${empty videoInfo ? '' : 'disabled' }>
	<br>
